...
C_SRCS += \
../littleshell/littleshell.c 

C_DEPS += \
./littleshell/littleshell.d 

OBJS += \
./littleshell/littleshell.o 


# Each subdirectory must supply rules for building sources it contributes
littleshell/%.o: ../littleshell/%.c littleshell/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-littleshell

clean-littleshell:
	-$(RM) ./littleshell/littleshell.d ./littleshell/littleshell.o

.PHONY: clean-littleshell
