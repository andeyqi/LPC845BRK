...
unsigned int crctest(char argc,char ** argv)
{
	...
	checksum32 = ef_calc_crc32(0x00,(unsigned char *)&testdata[0],4);

	PRINTF("fast crc32 1 %x\r\n",checksum32);

	checksum32 = ef_calc_crc32(checksum32,(unsigned char *)&testdata[0],4);

	PRINTF("fast crc32 2 %x\r\n",checksum32);
    ...
    CRC_WriteData(base, (uint8_t *)&testdata[0], 4);
    checksum32 = CRC_Get32bitResult(base);
	PRINTF("crc32 module 1 %x\r\n",checksum32);

    CRC_WriteData(base, (uint8_t *)&testdata[0], 4);
    checksum32 = CRC_Get32bitResult(base);
	PRINTF("crc32 module 2 %x\r\n",checksum32);
